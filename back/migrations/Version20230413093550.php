 ...
 */
final class Version20230413093550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ip (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', perimeter_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', ip_address VARCHAR(32) NOT NULL, INDEX IDX_A5E3B32D77570A4C (perimeter_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE perimeter (id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', domain_name VARCHAR(255) NOT NULL, contact_mail VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
